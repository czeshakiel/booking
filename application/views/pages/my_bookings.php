                        ...
                        foreach($bookings as $item){  
                            ...
                            ?>
                                <td>                                    
                                    ...
                                    <a href="<?= base_url('cancel_bookings/'.$item['booking_id']."/all"); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to cancel this booking?');" <?=$cancel;?>>Cancel</a>
                                </td>
                                <?php
                            echo "</tr>";
                            $counter++;
